...
public class PrintConceptEvaluation {
	...
	public PrintConceptEvaluation(File file, ObservableList<CourseOfAction> coaList, ObservableList<Specification> specList) 
			//,ObservableList<DesignSelection> selection)
{
	...
	public void printFile() throws IOException{
        ...
        doc.add(details);
        /* table = new Table(new float[]{8,3,3,3}); //table with four columns
